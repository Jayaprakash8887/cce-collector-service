...
class GlobalExceptionHandlerTest {
    ...
    class KafkaPublishFailure {
        ...
        @Test
        @DisplayName("Returns 500 with KAFKA_PUBLISH_FAILURE code")
        void returns500WithKafkaPublishFailure() {
            ...
            assertThat(response.getBody()).isNotNull();
            assertThat(response.getBody().error().code()).isEqualTo("KAFKA_PUBLISH_FAILURE");
            assertThat(response.getBody().error().message()).contains("Broker unavailable");
        }
    }
