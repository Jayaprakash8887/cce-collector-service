...
/**
 * Records rejection details on an {@link InboundEventLog}.
 *
 * <p>Rejection is tracked directly on the {@code inbound_event_log} table —
...
public class RejectionService {
    ...
    public void recordRejection(InboundEventLog event, RejectionReason reason, String errorDetails) {
